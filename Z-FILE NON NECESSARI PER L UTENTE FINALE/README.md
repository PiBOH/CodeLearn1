...
> 
> Con l' aggiornamento dopo dopo la `1.1.2d-X` è prevista l'introduzione della dark mode -> versione `1.X.Xx-X`
...
[![GitHub License](https://img.shields.io/github/license/PiBOH/CodeLearn?style=flat&cacheSeconds=1)](https://github.com/PiBOH/CodeLearn/blob/main/LICENSE.md)
...
## 🤖 [Build APK Android](https://github.com/PiBOH/Design-Arena-AI_APK-android/blob/main/CONTRIBUTING.md)
...
[GNU GPL v3.0](https://github.com/PiBOH/CodeLearn/blob/main/LICENSE.md)

***

## 🫂 Thanks To

### _**CODING and MAKEUP collaborators**_

- [Naereen](https://github.com/Naereen/) for the [Badge list, in markdown](https://naereen.github.io/badges/)
...
- [ITA]    [jac_0.10] for the anti-cheat idea and test.
- [ITA]    [Gab9021] for the general tests.
- [ITA]    [Jackk🌹] for the Synch Update idea.

### _**GENERAL SUPPORT**_

- [ITA]    [AlexGiulioBerton](https://github.com/AlexGiulioBerton) because he is the boss.
