#### il nome originale di questo file era "BUILDARE-APK+TESTARE-APP-SU-PC.md" ora è rinominato in "SUPPORT.md" per far si che vengaa visto in fianco al "README.md"
